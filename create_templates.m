...
Mnc=imread('image_5.bmp');
image_3=imread('image_3.bmp');
image_10=imread('image_10.bmp');


%*-*-*-*-*-*-*-*-*-*-*-

number=[one two three image_10 four fourfill five...
    six sixfill sixfill2 seven eight eightfill nine ninefill ninefill2 zero zerofill];%17%17+34=51
letter=[A Afill B Bfill C D Dfill E F G H I J K L M Mnc...
    N O Ofill P Pfill Q Qfill R Rfill image_3 S T U V W X Y Z];%34


character=[number letter];


NewTemplates=mat2cell(character,42,[ 24 24 24 24 24 24 24 24 ...%8
    24 24 24 24 24 24 24 ...%7
    24 24 24 24 24 24 24 ...
    24 24 24 24 24 24 24 ...
    24 24 24 24 24 24 24 ...
    24 24 24 24 24 24 24 ...
    24 24 24 24 24 24 24 24 24 24]);%42+1+8=51
